...
{
    public class LKCountriesController : Controller
    {
        private readonly PatientsContext _context;

        public LKCountriesController(PatientsContext context)
        {
            _context = context;
        }
